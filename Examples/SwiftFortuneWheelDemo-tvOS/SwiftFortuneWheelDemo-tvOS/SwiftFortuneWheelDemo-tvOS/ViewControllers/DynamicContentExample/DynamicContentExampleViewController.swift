//
//  DynamicContentExampleViewController.swift
...
class DynamicContentExampleViewController: UIViewController {

    @IBOutlet weak var drawCurvedLineSegment: UISegmentedControl!
    ...
    override func viewDidLoad() {
        ...
        drawCurvedLine = drawCurvedLineSegment.selectedSegmentIndex == 1
    ...
    @IBAction func drawCurverLineSegmentChanged(_ sender: UISegmentedControl) {
        drawCurvedLine = sender.selectedSegmentIndex == 1
    }
